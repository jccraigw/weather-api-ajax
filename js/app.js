...
var city;
 ...
 $(document).ready(function(){
	...
	success: function(response){
		...
		$('#location').html("<h1>" + city.name + "</h1>");
		$('#description').html("<h3>" + city.weather[0].description + "</h3");

		// var temp_convert = city.main.temp;
		// temp_convert = temp_convert * (9/5) - 459.67;	
		$('#temp').html(Math.ceil(city.main.temp));
		...
		$('#day').html("<h4>" + "<b>"+ day_text +"</b>" + " Today</h4>");
		$('#max').html("<h4>" + Math.ceil(city.main.temp_max) + "</h4>");
		$('#min').html("<h4>" + Math.ceil(city.main.temp_min)+ "</h4>");
		var i = 0;
		var cloud = "cloud";
		var rain = "rain";
		var thunder = "thunder";
